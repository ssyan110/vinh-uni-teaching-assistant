...
- 全书盘点：`course/boya-quasi-intermediate/source-inventory.json`
- QR 截图：`course/boya-quasi-intermediate/qr-captures/`
- QR 扫描记录：`course/boya-quasi-intermediate/qr-scan.tsv`
- 本地音频与重试报告：`work/boya-quasi-intermediate/source-audit/`（不上传 Git）
