...
- **Pinyin practice styles:** Future pinyin exercises reuse `scripts/pinyin-exercise-templates.mjs`: Lesson 1 slide 15 for reading drills, slide 36 for `连连看` / matching, slide 37 for multiple choice/listening choice, and slide 38 for fill-in-blank/listening completion. For matching exercises, randomize/derange the Vietnamese meaning column so meanings do not stay in the same row as their pinyin/hanzi prompts. Split dense matching across slides instead of shrinking or crowding.
