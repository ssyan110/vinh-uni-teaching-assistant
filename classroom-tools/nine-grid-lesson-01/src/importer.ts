...
function finalizePack(
  ...
  return {
    pack: {
      ...
      textbook_id: text(source.textbook_id) || undefined,
      content_mode: source.content_mode === "pinyin" ? "pinyin" : "vocabulary",
      content_status: text(source.content_status) || undefined,
