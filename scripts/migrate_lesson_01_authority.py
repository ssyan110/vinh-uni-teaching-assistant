...
SOURCE_PACKAGE = project_path(CONFIG["frozen_final_package_source"])
...
LEGACY_ROOT = project_path(CONFIG["legacy_lesson_root"])
...
def build_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "source_package": {
            "path": CONFIG["frozen_final_package_source"],
            "status": "frozen_input",
            "file_count": len(
...
def migrate() -> dict[str, Any]:
    ...
    semester_manual = PROJECT_ROOT / "output/boya-intermediate/teacher-manual/boya-intermediate-i-semester-teacher-manual.md"
