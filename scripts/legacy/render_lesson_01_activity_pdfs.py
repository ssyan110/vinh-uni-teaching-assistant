...
ACTIVITY_ROOT = PROJECT_ROOT / "archive/legacy-materials-2026-08-27/boya-intermediate/lesson-01/activities"
FONTCONFIG = PROJECT_ROOT / "scripts/legacy/lesson-01-fontconfig.conf"
LIBREOFFICE = (
