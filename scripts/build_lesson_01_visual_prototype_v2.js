...
const outputDir = path.join(projectRoot, 'output/boya-intermediate/lesson-01/visual-prototype');
const assetDir = path.join(outputDir, 'assets');
const contactSheet = path.join(
  projectRoot,
  'output/boya-intermediate/lesson-01/visual-storyboard/assets/lesson-01-textbook-contact-sheet-4x4.png'
);
...
function writeManifest() {
  const manifest = {
    ...
    html_required: false,
    slide_count: 6,
    source_contact_sheet: 'output/boya-intermediate/lesson-01/visual-storyboard/assets/lesson-01-textbook-contact-sheet-4x4.png',
