...
function coverSlide() {
  return bareSlide({
    title: 'Pinyin Bài 1',
    body: `<div class="cover"><div class="cover-card"><div class="lesson">PINYIN 1 · 拼音第一课</div><div class="aligned-text cover-align"><span class="a-word"><span class="a-pin">pīn</span><span class="a-han">拼</span></span><span class="a-word"><span class="a-pin">yīn</span><span class="a-han">音</span></span></div><div class="vi">Cơ bản: phát âm nhập môn</div></div><div class="topic-img"><img src="assets/photos/cover-topic.png" alt=""></div></div>`,
  });
}
...
function closingSlide() {
  return bareSlide({
    title: 'Kết thúc',
    extraClass: 'closing',
    extraCss: `.closing{background:url('assets/reference/ending-page-background.png') center/cover no-repeat;display:flex;align-items:center;justify-content:center}.closing-overlay{position:absolute;inset:0;background:rgba(255,255,255,.22)}.closing-center{position:relative;z-index:1;text-align:center;background:rgba(255,255,255,.88);border-radius:28px;padding:34px 78px;box-shadow:0 10px 34px rgba(26,58,90,.16)}.closing-center .closing-zh{font-family:'Noto Sans SC';font-size:62pt;line-height:1;color:#1A3A5A}.closing-center .line{margin:16px auto}.closing-sub{font-size:18pt;font-weight:900;color:#5AACAC}.closing-next{margin-top:14px;font-size:14pt;color:#5F7088;font-weight:800}`,
    body: `<div class="closing-overlay"></div><div class="closing-center"><div class="closing-zh">下课</div><div class="line"></div><div class="closing-sub">Hôm nay đọc đúng là thắng</div><div class="closing-next">Bài tiếp theo: tiếp tục luyện pinyin theo nhóm âm mới</div></div>`,
  });
}
