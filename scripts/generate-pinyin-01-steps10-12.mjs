...
function closingSlide() {
  return bareSlide({
    ...
    body: `<div class="closing-overlay"></div><div class="closing-center"><div class="closing-zh">下课</div><div class="line"></div><div class="closing-sub">Bạn có câu hỏi gì không?</div><div class="closing-next">Bài tiếp theo: Pinyin 2</div></div>`,
  });
}
