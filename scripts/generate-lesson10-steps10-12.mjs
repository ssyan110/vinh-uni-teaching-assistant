...
${alignedCss}body{background:#fff}.cover{position:absolute;inset:0;background:linear-gradient(145deg,#F4FAFA 0%,#FFFFFF 56%,#F3F0FA 100%);overflow:hidden}.cover:before{content:"";position:absolute;right:-80px;top:-120px;width:360px;height:360px;border-radius:50%;background:rgba(90,172,172,.13)}.cover-card{position:absolute;left:62px;top:78px;width:520px;z-index:2}.lesson{display:inline-flex;align-items:center;gap:10px;background:#E8F4F4;color:#5AACAC;padding:8px 16px;border-radius:999px;font-weight:800;font-size:12pt}.cover-align{justify-content:flex-start;gap:14px;margin-top:26px}.cover-align .a-word{min-height:88px}.cover-align .a-pin{font-size:16pt}.cover-align .a-han,.cover-align .a-punct{font-size:62pt}.vi{font-size:24pt;color:#4A6080;font-weight:800;margin-top:20px}.chips{display:flex;gap:10px;margin-top:30px}.chip{background:#fff;border:1px solid rgba(90,172,172,.18);box-shadow:0 8px 24px rgba(90,172,172,.12);border-radius:14px;padding:10px 16px;font-weight:800;color:#4A6080}.topic-img{position:absolute;right:48px;top:114px;width:330px;height:246px;border-radius:24px;overflow:hidden;background:#F8FBFB;border:2px solid rgba(90,172,172,.18);box-shadow:0 16px 44px rgba(26,58,90,.16)}.topic-img img{width:100%;height:100%;object-fit:cover}</style></head><body><div class="cover"><div class="cover-card"><div class="lesson">BÀI 10 · 第十课</div>${alignedText('他住哪儿？', 'tā zhù nǎr?', 'cover-align')}<div class="vi">Anh ấy sống ở đâu?</div><div class="chips"><span class="chip">hỏi người</span><span class="chip">địa chỉ</span><span class="chip">số điện thoại</span></div></div><div class="topic-img"><img src="assets/photos/cover-topic.png" alt=""></div></div></body></html>`);
...
let presenter = lesson01Presenter
  ...
  .replace(/lesson-01-teacher-deck\.pdf/g, 'lesson-10-teacher-deck.pdf');
