...
> 更新日期：2026-08-27
> 当前状态：新教材来源审核进行中；学期时数与逐课教学设计尚未安排。
...
- 当前只开放新教材第一课的来源审核；未获批准前不进入教师手册、学生配套或 PPTX 生产。
...
| 当前课次 | `lessons/boya-quasi-intermediate-i/lesson-01/00-source/` | 第一课来源审核包 |
...
- 现行交付格式为原生、可编辑、静态 16:9 PPTX；完整 PPTX 必须在教师手册批准后制作。

《中级冲刺篇 I》先前为 2026-fall 准备的学期安排上下文保存在 `course/offerings/2026-fall/legacy/boya-intermediate-i/TEACHING_CONTEXT.md`；教材本身与逐课成果继续保留在标准教材结构中，并由 `2027-fall` 开课实例承接。
