...
| 教材印刷页 | 63–78，共16页 |
| PDF页 | 74–89，共16页 |
| PDF | `Giáo trình/博雅汉语听说-中级冲刺篇/博雅汉语听说-中级冲刺篇I.pdf` |
...
- `work/boya-intermediate/extractions/ocr-lesson-05/manifest.json`
- `work/boya-intermediate/extractions/ocr-lesson-05/page-074.txt` 至 `page-089.txt`
- `work/boya-intermediate/extractions/pages-preview/lesson-05/page-074.png` 至 `page-089.png`
- `lessons/lesson-05/00-source/source-manifest.json`
- 本文件

旧的 `work/boya-intermediate/extractions/lesson-05.json` 只作为已核对的 legacy 参考；本课 canonical source 是新写入的 `structured-lesson-05.json`。
...
|---|---:|---:|---|---|---|
| 1-1 | 63–64 | 69.172250 | `9476a4092d51` | `音频/第05课/1-1.mp3`；pass | confirmed_by_user |
| 1-2 | 65 | 117.002438 | `6faa5516083b` | `音频/第05课/1-2.mp3`；pass | confirmed_by_user |
| 1-3 | 65–66 | 59.480813 | `1d7e849f0a61` | `音频/第05课/1-3.mp3`；pass | confirmed_by_user |
| 1-4 | 66 | 56.006500 | `ba587eaa5dd4` | `音频/第05课/1-4.mp3`；pass | confirmed_by_user |
| 1-5 | 66 | 42.631813 | `35af2d0d0b17` | `音频/第05课/1-5.mp3`；pass | confirmed_by_user |
| 1-6 | 67 | 207.647375 | `06b401040e8d` | `音频/第05课/1-6.mp3`；pass | confirmed_by_user |
| 2-1 | 71–72 | 48.248188 | `7b877d6ed81d` | `音频/第05课/2-1.mp3`；pass | confirmed_by_user |
| 2-2 | 72 | 147.983688 | `26db738b024f` | `音频/第05课/2-2.mp3`；pass | confirmed_by_user |
| 2-3 | 72–73 | 54.125688 | `5eb1a3df4ab7` | `音频/第05课/2-3.mp3`；pass | confirmed_by_user |
| 2-4 | 73 | 47.177125 | `731ffaddcf5b` | `音频/第05课/2-4.mp3`；pass | confirmed_by_user |
| 2-5 | 74 | 44.094688 | `911ca864e984` | `音频/第05课/2-5.mp3`；pass | confirmed_by_user |
| 2-6 | 74–75 | 215.405688 | `5cbc60042f81` | `音频/第05课/2-6.mp3`；pass | confirmed_by_user |

音频来源目录为 `Giáo trình/博雅汉语听说-中级冲刺篇/音频/第05课/`，来源说明为该目录内的 `下载来源.md`。本次完成了存在性、时长、SHA-256 和 ffmpeg 解码核验；Adam已确认音档正确，代理没有实际听取内容，不生成语义转写或答案。
