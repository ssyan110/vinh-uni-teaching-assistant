...
- 结构化来源：[textbooks/boya-intermediate-i/source/derived/extractions/structured-lesson-06.json](../../../textbooks/boya-intermediate-i/source/derived/extractions/structured-lesson-06.json)
- 来源 manifest：[lessons/boya-intermediate-i/lesson-06/00-source/source-manifest.json](source-manifest.json)
- OCR manifest：`textbooks/boya-intermediate-i/source/derived/extractions/ocr-lesson-06/manifest.json`
- OCR：`textbooks/boya-intermediate-i/source/derived/extractions/ocr-lesson-06/page-090.txt` 至 `page-106.txt`，共 17 页
- 页面预览：`textbooks/boya-intermediate-i/source/derived/extractions/pages-preview/lesson-06/pdf-090.png` 至 `pdf-106.png`，共 17 页，当前 PDF 以 200 DPI 渲染
