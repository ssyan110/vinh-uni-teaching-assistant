...
- 结构化来源快照：`work/boya-intermediate/extractions/structured-lesson-04.json`
- OCR 页面：`work/boya-intermediate/extractions/ocr-lesson-04/`
- 页面图像：`work/boya-intermediate/extractions/pages-preview/lesson-04/`
- 音频目录：`Giáo trình/博雅汉语听说-中级冲刺篇/音频/第04课/`
